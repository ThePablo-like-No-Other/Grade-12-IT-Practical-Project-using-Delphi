...
uses
  ...
  U_LoginAccount in 'U_LoginAccount.pas' {frmLogin},
  ...
  U_AdminClientAccounts in 'U_AdminClientAccounts.pas' {FrmClienteAdmin},
  MultiUseUnit in 'MultiUseUnit.pas';
...
begin
  ...
  Application.CreateForm(TFrmClienteAdmin, FrmClienteAdmin);
  Application.Run;
end.
